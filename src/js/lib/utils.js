...
export const collisionDetected = (shape1, shape2) => shape1.position.x <= shape2.position.x + shape2.width
...
export const distance = (point1, point2) => Math.sqrt((point1.x - point2.x) ** 2 + (point1.y - point2.y) ** 2);
